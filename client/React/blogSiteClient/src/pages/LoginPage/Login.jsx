                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td className="input"><input type="email" id="email" onChange={(e)=>{setEmail(e.target.value)}}/></td>
                            </tr>
                            <tr>
                                <td className="label"><label htmlFor="password">Password</label></td>
                                <td className="input"><input type="password" id="password" onChange={(e)=>{setPassword(e.target.value)}}/></td>
                            </tr>
                            <tr>
                                <td colSpan="2" className='buttons'>
                                    <button className="button" onClick={onLogin}>Sign in</button>
