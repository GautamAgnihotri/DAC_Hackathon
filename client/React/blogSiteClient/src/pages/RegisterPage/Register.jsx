                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td className="input"><input type="email" id="email" onChange={(e)=>setUserInfo({...userObj,email:e.target.value})}/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colSpan="2" className='buttons'>
                                    ...
                                    <button className="button" onClick={()=>{navigate('/')}}>Sign in</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
